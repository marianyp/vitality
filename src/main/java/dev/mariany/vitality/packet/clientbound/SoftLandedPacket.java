...
public record SoftLandedPacket(int entityId, double x, double y, double z) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, SoftLandedPacket> CODEC = PacketCodec.tuple(
            PacketCodecs.VAR_INT, SoftLandedPacket::entityId,
            PacketCodecs.DOUBLE, SoftLandedPacket::x,
            PacketCodecs.DOUBLE, SoftLandedPacket::y,
            PacketCodecs.DOUBLE, SoftLandedPacket::z,
            SoftLandedPacket::new
    );
